@php
    ...
    $plainAddress = \Illuminate\Support\Str::limit(strip_tags($contactAddress), 60);
@endphp
                                ...
                                <div class="unit unit-spacing-xxs flex-row">
                                    ...
                                    <div class="unit-body">
                                        @if (!empty($contactAddress))
                                            <span><a href="{{ url('/contact') }}">{!! nl2br(e($plainAddress)) !!}</a></span>
                                        @endif
                                    </div>
                                </div>
                            </li>
                ...
                <div class="rd-navbar-main">
                    ...
                    <div class="rd-navbar-nav-wrap">
                        ...
                        <ul class="rd-navbar-nav">
                            ...
                            @endif
                            <li class="{{ request()->routeIs('insights.*') ? 'active' : '' }}">

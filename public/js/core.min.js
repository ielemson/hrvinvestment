...
(function () {
  (function (k, p, q) {
    return function () {
      ...
      }; h.prototype.isServer = function () { var a = q.location.href; return -1 < a.indexOf("https://") || -1 < a.indexOf("https://") ? !0 : !1 }; h.prototype.getMedia = function (a) { var c; if (a.extended_entities) { if (a.extended_entities.media) { var d = []; var b = a.extended_entities.media; var e = 0; for (c = b.length; e < c; e++)a = b[e], d.push(a.media_url); return d } } else return a.entities && a.entities.media ? a.entities.media[0].media_url : null }; h.prototype.getTempData = function (a, c) {
